...
# ============================================================
# 早间提示词 — 全球市场 + 贵金属/能源 + AI动态 + 科普 + G20成员国
# ============================================================
...
- 重点关注以下领域：
  ...
  5. 亚洲大公司、中国大公司、中国科创公司、国际消费品
  6. G20成员国值得关注的新闻
- 只报道新闻中明确提到的内容，不要编造数据、价格或事件

**二、科普时间**
- 从今日新闻中挑出 2-3 个最重要的专业概念或术语
- 用通俗语言解释：这个概念是什么？为什么它重要？对个人投资者有何警醒或启发或预示？这个事件的来龙去脉是什么？
- 科普要和新闻自然衔接，不要生硬插入
- 只科普确实重要且读者可能不熟悉的概念，常见词汇不用解释
- 这个G20国家为什么会发生这个事？来龙去脉是什么？目的是什么？背后矛头是什么？有谁主导？
